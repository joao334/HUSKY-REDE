-- Use este arquivo quando o projeto Supabase ja tem as tabelas base.
-- Ele NAO recria users_profiles/products/posts do zero.
-- Roda apenas os ajustes novos: login Google, perfil automatico, feed social, stories de clientes,
-- posts salvos e reposts.
